...
movies.forEach(movie => {
    ...
    article.innerHTML = `
        ...
        <img src="${movie.imgSrc}" alt="${movie.imgAlt}">
            ...
            <p id='desc' aria-label="Description">${movie.description}</p>
    `;
...
/*<article class="movie">
    ...
    <img src="https://wddbyui.github.io/wdd131/images/spiderman.png" alt="Miles Morales swinging through the city">
        ...
        <p id='desc' aria-label="Description">Miles Morales becomes the Spider-Man of his reality and crosses paths with others from the multiverse.</p>
</article>
*/